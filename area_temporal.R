...
aux_2015a <- saber2015_Aquia %>%
             ...
             select(Cod_colegio, freq_Hogar_internet)
...
aux_2015b <- saber2015_Aquia %>%
             ...
             select(Cod_colegio, freq_Hogar_PC)
...
saveRDS(Colegios_2015, "./RDS/Colegios_2015")
...
saveRDS(Colegios_2016, "./RDS/Colegios_2016")
...
names(Colegios_2017)
saveRDS(Colegios_2017, "./RDS/Colegios_2017")
